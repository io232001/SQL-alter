...
public class Start {
    public static void main(String[] args)
    {
        ...
        try {
            ...
            statement.executeUpdate("UPDATE student SET country = 'France' where student_id = 1;");
            ...
            statement.executeUpdate("UPDATE student SET country = 'Spain' where student_id = 10;");
        }
